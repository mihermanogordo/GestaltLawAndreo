...
export const StaggeredMenu = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={preLayersRef}
          className="sm-prelayers absolute top-0 right-0 bottom-0 pointer-events-none z-[5] w-96"
          aria-hidden="true"
        >
          {(() => {
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] w-96"
  ...
  className="sm-socials-link text-[1.2rem] font-light text-[#111] no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear pointer-events-auto cursor-pointer"
>
  {s.label}
</a>
                    </li>
...
.sm-scope .sm-panel-item { 
  ...
  padding-right: 1.4em; 
  pointer-events: auto !important; /* Asegurar eventos */
}
...
/* Asegurar que todo el panel sea interactivo */
.sm-scope .staggered-menu-panel * {
  pointer-events: auto;
}
...
.sm-scope .staggered-menu-wrapper[data-open] .sm-panel-item,
.sm-scope .staggered-menu-wrapper[data-open] .sm-socials-link {
